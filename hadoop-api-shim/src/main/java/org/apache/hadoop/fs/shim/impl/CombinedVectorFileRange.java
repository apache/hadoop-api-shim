 ...
 * This is used when we combine the user's VectorFileRange objects
 * together into a single read for efficiency.
 */
public class CombinedVectorFileRange extends VectorFileRangeImpl {
  private List<VectorFileRange> underlying = new ArrayList<>();


  public CombinedVectorFileRange(long offset, long end, VectorFileRange original) {
   ...
   */
  public List<VectorFileRange> getUnderlying() {
    return underlying;
  }
   ...
   * @param other the underlying VectorFileRange to add if we merge
   ...
   */
  public boolean merge(long otherOffset, long otherEnd, VectorFileRange other,
