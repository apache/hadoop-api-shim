 ...
 * factory defined in {@code VectorFileRange#createFileRange} should be used.
 */
@InterfaceAudience.Private
public class VectorFileRangeImpl implements VectorFileRange {
  private long offset;
  private int length;
   ...
   */
  public VectorFileRangeImpl(long offset, int length, Object reference) {
    this.offset = offset;
    this.length = length;
